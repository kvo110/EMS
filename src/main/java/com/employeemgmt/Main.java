...
import com.employeemgmt.ui.LoginScreen;
import javafx.application.Application;

/*
This version of Main now opens the JavaFX login screen instead of using console input.
It still serves as the main entry point for the entire project.
When you run the program, the login screen will be the first thing that appears.
*/
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // start the JavaFX login UI instead of console login
        try {
            Application.launch(LoginScreen.class, args);
        } catch (Exception e) {
            // simple error handling if JavaFX fails to load
            System.out.println("Error launching the JavaFX login screen.");
            e.printStackTrace();
        }
    }
}
...
// ---- Previous Main.java file before GUI Implementation ----
